      ...
      >
        ...
        <div className="grid gap-1.5">
          {payload.map((item: any, index: number) => {
            ...
            const itemPayloadFill = itemPayload && typeof itemPayload === 'object' && 'fill' in itemPayload ? itemPayload.fill : undefined;
                    ...
                    >
                      ...
                      {typeof item?.value !== 'undefined' && item?.value !== null && (
                        <span className="font-mono font-medium tabular-nums text-foreground">
                          {typeof item.value === 'number' || typeof item.value === 'string' ? item.value.toLocaleString() : String(item.value)}
                        </span>
                      )}
                    </div>
                  </>
